<template>
  <div class="home-header" v-if="seller">
    ...
    <header-more :seller="seller" v-show="showMore" @close="closeMore"></header-more>
  </div>
</template>

<script>
  import HeaderMore from '@/pages/detail/components/HeaderMore'
  export default {
    name: "HomeHeader",
    props: {
      seller: Object
      ...
      .content
        ...
        .supports
          ...
          .icon
            ...
            &.decrease
              bg-icon("./images/decrease_1")
            &.discount
              bg-icon('./images/discount_1')
            &.guarantee
              bg-icon('./images/guarantee_1')
            &.invoice
              bg-icon('./images/invoice_1')
            &.special
              bg-icon('./images/special_1')
          .text
            height 12px
            font-size 10px
            font-weight 200
